BZFlag Server Plugin: tripleBarrelFlag
================================================================================
...
tripleBarrelFlag directory to a new name, and then manually replace tripleBarrelFlag
...
To load the plugin with specific settings, use the format:
  -loadplugin tripleBarrelFlag,<powerlevel>,<meaning>,<leet>
For example:
  -loadplugin tripleBarrelFlag,1006,42,1337

To load the plugin and specify a configuration file, use the format:
  -loadplugin tripleBarrelFlag,<configfilename>
For example:
  -loadplugin tripleBarrelFlag,/path/to/my/sampleplugin.cfg
